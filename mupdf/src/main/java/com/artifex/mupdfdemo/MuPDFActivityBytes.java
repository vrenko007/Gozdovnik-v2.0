...
public class MuPDFActivityBytes extends Activity implements FilePicker.FilePickerSupport
{
            ...
            if (savedInstanceState != null && savedInstanceState.containsKey("FileName")) {
                {
                    ...
                    if(savedInstanceState.containsKey("buffer"))
                    {
                        buffer = savedInstanceState.getByteArray("buffer");
                    }
            ...
            mOutlineButton.setOnClickListener(new View.OnClickListener() {
                public void onClick(View v) {
                    ...
                    if (outline != null) {
                        ...
                        Intent intent = new Intent(MuPDFActivityBytes.this, OutlineActivity.class);
